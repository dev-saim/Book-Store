...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <p align="left" class="email-error" class="p-marg p1-vis"> Invalid name </p>
      ...
      <input type="button" name="submit" id="button" value="login now" class="btn" onclick="check()">
      <p class="temp">Don't have an account? <a href="register.php">register now</a></p>
   </form>
