...
if(isset($_POST['submit'])){
   ...
   {
        mysqli_query($conn, "UPDATE users SET password='$pass' WHERE name='$name'") or die('query failed');
...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="password" id="password" placeholder="Enter new password" class="box">
      <p align="left" class="password-error" class="p-marg p1-vis"> Invalid name </p>

      <input type="password" name="cpassword" id="confirmpass" placeholder="Confirm new password" class="box">
      ...
      <input type="button" name="submit" id="button"  value="Forget" onclick="check()" class="btn">
